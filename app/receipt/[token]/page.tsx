      ...
      <main className="mx-auto w-full max-w-md space-y-6 p-6 pt-24 pb-44 text-[#3E2723]">
        ...
        <div className="flex gap-3 pt-2">
          ...
          <a
            ...
            className={`flex items-center justify-center gap-2 py-3 bg-[#25D366] rounded-xl text-[12px] font-medium text-white active:scale-[0.97] transition-transform ${handover.receipt_url ? "flex-1" : "w-full"}`}
          >
